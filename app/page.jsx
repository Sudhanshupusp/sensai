  ...
  return (
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter text-center mb-12">
            powerfull Feature for Your Career Growth
          </h2>
      ...
      <section className="w-full">
        <div className="mx-auto py-24 roundent-lg bg-gradient-to-b  from-gray-400 via-gray-200 to-gray-600">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold tracking-tighter text-primary-foreground sm:text-4xl md:text-5xl mb-14">Ready to accelerate your career?</h2>
            <p className="mx-auto max-w-[600px]  text-primary-foreground/80 md:text-xl">Join thousands  of Professional who are advancing their careers with AI-powered guidence.</p>
